...
export function NotificationCard ({
    ...
    return (
        <div className="rounded-lg p-1 bg-gradient-to-r from-red-300 via-red-400 to-red-500 flex">
            <div
                className="w-80 bg-white dark:bg-gray-800 border border-transparent rounded-lg shadow-sm cursor-pointer hover:shadow-md transition p-3 flex items-center justify-between"
                role="button"
                tabIndex={0}
