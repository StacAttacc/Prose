...
export default function Notifications() {
    ...
    const handleItemClick = useCallback((e, notification) => {
        e.stopPropagation();
        setOpen(false);
    ...
    return (
        <div className="relative inline-block text-left" ref={dropdownRef}>
            ...
            >
                    ...
                    <div>
                        ...
                        {!loading && (
                            error ? (
                                ...
                                <div className="mt-3 text-sm text-gray-500">No notifications</div>
                            ) : count <= 3 ? (
                ...
                <div className="flex items-center gap-2">
                    {count >= 4 && (
                        ...
                        >
                            <svg className={`m-2 w-4 h-4 transition-transform ${open ? "transform rotate-180" : ""}`} viewBox="0 0 20 20" fill="currentColor" aria-hidden>
            ...
            {count >= 4 && (
                <div id={dropdownId} className={`origin-top-right absolute right-0 mt-2 w-full z-50 ${open ? "block" : "hidden"}`} role="menu" aria-hidden={!open}>
                                        ...
                                        <li key={n.id}>
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="text-sm font-medium text-gray-900 truncate" title={n.message || ""}>
