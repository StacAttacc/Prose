...
const translations = {
  fr: {
    ...
    'gestionnaire.commentairesPlaceholder': 'Ajoutez vos commentaires basés sur vos visites et observations...',
    ...
    'gestionnaire.champRequis': 'Tous les champs obligatoires doivent être remplis',
    ...
    'gestionnaire.evaluationCompletee': 'Évalué',
    'gestionnaire.evaluationEnAttente': 'En attente',
    'gestionnaire.voirEvaluation': 'Voir l\'évaluation',
    'gestionnaire.evaluerMilieu': 'Évaluer',
    ...
    'gestionnaire.statutStage': 'Statut du stage',
    'gestionnaire.ententeSignee': 'Entente signée',
    'gestionnaire.enAttente': 'En attente',
  ...
  en: {
    ...
    'gestionnaire.evaluationMilieuDescription': 'Evaluate the internship environment for students on internship',
    'gestionnaire.evaluantStage': 'Evaluating the internship of',
    ...
    'gestionnaire.adresse': 'Address',
    'gestionnaire.ville': 'City',
    'gestionnaire.codePostal': 'Postal Code',
    'gestionnaire.telephone': 'Phone',
    'gestionnaire.telecopieur': 'Fax',
    ...
    'gestionnaire.tachesCoformes': 'The assigned tasks correspond to the internship objectives',
    'gestionnaire.faciliteIntegration': 'Ease of integration into the team',
    'gestionnaire.tempsEstReel': 'The allocated time is realistic for the assigned tasks',
    'gestionnaire.hygieneRespectable': 'Hygiene is respectable',
    'gestionnaire.climatTravailAgreable': 'The work environment is pleasant',
    'gestionnaire.accessibleTransportCommun': 'Accessible by public transportation',
    'gestionnaire.salaireIneteressant': 'The salary is interesting',
    'gestionnaire.salaire': 'Salary',
    'gestionnaire.communicationSuperviseurFacile': 'Communication with the supervisor is easy',
    'gestionnaire.equipementAdequat': 'The equipment is adequate',
    'gestionnaire.volumeTravailAcceptable': 'The workload is acceptable',
    'gestionnaire.commentaires': 'Comments',
    'gestionnaire.commentairesPlaceholder': 'Add your comments based on your visits and observations...',
    'gestionnaire.informationsSupplementaires': 'Additional Information',
    'gestionnaire.privilegieStage': 'Prioritizes internship',
    'gestionnaire.nbStagiaires': 'Number of interns',
    'gestionnaire.desireAutreStagiaires': 'Desires other interns',
    'gestionnaire.quartsVariables': 'Variable shifts',
    'gestionnaire.sauvegarder': 'Save',
    'gestionnaire.evaluationSauvegardee': 'Evaluation saved successfully!',
    'gestionnaire.erreurSauvegarde': 'Error saving',
    'gestionnaire.champRequis': 'All required fields must be filled',
    'gestionnaire.evaluationRequis': 'All evaluations are required',
    'gestionnaire.candidatureNonTrouvee': 'Application not found',
    'gestionnaire.erreurChargement': 'Error loading the application',
    'gestionnaire.erreurChargementCandidatures': 'Error loading applications',
    'gestionnaire.stage': 'Internship',
    'gestionnaire.entreprise': 'Company',
    'gestionnaire.professeur': 'Professor',
    'gestionnaire.evaluationCompletee': 'Evaluated',
    'gestionnaire.evaluationEnAttente': 'Pending',
    'gestionnaire.voirEvaluation': 'View Evaluation',
    'gestionnaire.evaluerMilieu': 'Evaluate',
    'gestionnaire.aucuneCandidatureEnStage': 'No internship applications',
    'gestionnaire.aucuneCandidatureEnStageDescription': 'No applications with ongoing internship found.',
    'gestionnaire.statutStage': 'Internship Status',
    'gestionnaire.ententeSignee': 'Agreement Signed',
    'gestionnaire.enAttente': 'Pending',
